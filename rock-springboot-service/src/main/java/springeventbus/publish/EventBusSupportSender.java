...
public class EventBusSupportSender {
    ...
    public void sendEvents() {
        SimpleEvent simpleEvent = new SimpleEvent(1,"jerry");
        this.eventBusSupport.post(simpleEvent);
        this.eventBusSupport.postAsync(simpleEvent);
    }
